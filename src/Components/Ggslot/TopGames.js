                ...
                <div className="casino__list pl-40 pr-40 mb-3">
                    <div className="d-flex w-100">
                        <div className="casino__item casino__item_big" onClick={() => this.playGame('starburst')}>
                            <LazyBackgroundImage image="./images/casino/starburst.jpg" fallbackImage="./images/loading-dark.gif" className="casino__img11" />
                        </div>
                    ...
                    <div className="d-flex w-100">
                        ...
                        <div className="casino__item casino__item_big" onClick={() => this.playGame('eldorado')}>
                            <LazyBackgroundImage image="./images/casino/gonzos-quest.jpg" fallbackImage="./images/loading-dark.gif" className="casino__img1" />
                        </div>
                    </div>
                    ...
                    <div className="d-flex w-100">
                        <div className="casino__items">
                            <div className="casino__item casino__item_big" onClick={() => this.playGame('bookofradeluxe')}>
                                <LazyBackgroundImage image="./images/casino/book-of-ra.jpg" fallbackImage="./images/loading-dark.gif" className="casino__img1" />
                            </div>
                        ...
                        <div className="casino__items">
                            ...
                            <div className="casino__item casino__item_big" onClick={() => this.playGame('berryburst')}>
                                <LazyBackgroundImage image="./images/casino/berry-burst.jpg" fallbackImage="./images/loading-dark.gif" className="casino__img1" />
                            </div>
                        </div>
                    </div>
                </div>
