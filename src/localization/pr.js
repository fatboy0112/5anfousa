export const pr = {
    ...
    virtualSports: 'Esportes virtuais',
    casino: 'Cassino',
    myBets: 'Minhas Apostas',
    deposit: 'Depósito',
    enterAmount: 'Insira o valor',
    qrScan: 'Atenção: o QRCode expira em 5 minutos. Caso seja necessário, por favor gere outro QRCode para pagamento.',
    continue: 'Prosseguir',
    home: 'Início',
    login: 'Login',
    signup: 'Se registre',
    ...
    odd: 'Odd',
    totalPossibleWin: 'Total de vitória possível',
    placeBet: 'Fazer aposta',
    bet: 'aposta',
    fastBet : 'Aposta Rápida',
    fastBet1: 'rápido',
    fastBet2: 'aposta',
    username: 'Nome de usuário',
    password: 'Alterar a senha',
    passwordAgain : 'Confirme a Senha',
    ...
    refund: 'Reembolso',
    date: 'Data',
    winAmount: 'quantidade de vitória',
    stake: 'Valor',
    pick: 'Selecionar',
    ...
    volleyball: 'Vôlei',
    boxing: 'Boxe',
    pickCanNotBeCombined: 'Esta escolha não pode ser combinada',
    matchStopped: 'Partida interrompida',
    favorites: 'Favoritos',
    cashout: 'Saque',
    ...
    under: 'Sob',
    even: 'Até',
    areYouSureWantCashout: 'Tem certeza que deseja fazer um saque?',
    no: 'Não',
    bonus: 'Bônus',
    ...
    withdraw: 'Retirar o',
    totalOdd: 'Odd Total',
    totalStake: 'Valor Total',
    topGames: 'Melhores Jogos',
    allGames: 'Todos os Jogos',
    canNotBeCombined: 'Não pode ser combinado',
    betSettled: 'aposta Resolvidas',
    betSuspended: 'aposta Suspenso',
    ...
    repeatBet: 'Repita Aposta',
    someThingWrong: 'Algo deu errado',
    status: 'Status',
    coupon: 'Cupom',
    acceptOddChangesText: 'Você precisa aceitar as alterações para poder fazer uma aposta',
    turnOffAway: 'Desligue mesmo assim',
    acceptOddChanges: 'Aceite mudanças estranhas',
    maxWinAmount: 'Quantidade máxima de ganhos',
    maxOdd: 'Ímpar máximo',
    dateTime: 'Data/Tempo',
    type: 'Tipo',
    refreshCashout: 'atualizar o saque',
    vendor: 'Fornecedor',
    stakeLowerThen1: 'A aposta deve ser menor que',
    stakeGreaterThen1: 'A aposta deve ser maior que',
